...
RegisterNetEvent("fivem-appearance:client:migration:load-norskpixel-clothing-skin", function(playerSkin)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent('fivem-appearance:client:migration:load-norskpixel-clothing-clothes', playerSkin, PlayerPedId())
    end)
end)

RegisterNetEvent('fivem-appearance:client:migration:load-norskpixel-clothing-clothes', function(playerSkin, ped)
    ...
    TriggerServerEvent("fivem-appearance:server:migrate-norskpixel-clothing-skin", playerSkin.citizenid, appearance)
end)
