...
qbCityhall.Close = function() {
    ...
    $.post('https://norskpixel-cityhall/close');
...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $.post('https://norskpixel-cityhall/requestLicenses', JSON.stringify({}), function(licenses){
...
$(".request-identity-button").click(function(e){
    ...
    $.post('https://norskpixel-cityhall/requestId', JSON.stringify({
...
$(document).on('click', '.apply-job-button', function(e){
    ...
    $.post('https://norskpixel-cityhall/applyJob', JSON.stringify({
        job: selectedJobId
    }))
