...
$(document).on("dblclick", ".item-slot", function(e) {
    ...
    if (ItemData) {
        Inventory.Close();
        $.post(
            "https://norskpixel-inventory/UseItem",
            JSON.stringify({
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://norskpixel-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://norskpixel-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", "#weapon-attachments", function(e) {
    ...
    if (!Inventory.IsWeaponBlocked(ClickedItemData.name)) {
        ...
        $.post(
            "https://norskpixel-inventory/Notify",
            JSON.stringify({
...
function handleDragDrop() {
    ...
    $("#item-drop").droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post(
                "https://norskpixel-inventory/DropItem",
                JSON.stringify({
                    inventory: fromInventory,
                    item: fromData,
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://norskpixel-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://norskpixel-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://norskpixel-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://norskpixel-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://norskpixel-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://norskpixel-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://norskpixel-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://norskpixel-inventory/CloseInventory", JSON.stringify({}));
...
$(document).on("click", "#rob-money", function(e) {
    ...
    $.post(
        "https://norskpixel-inventory/RobMoney",
        JSON.stringify({
            TargetId: TargetId,
        })
    );
...
$("#item-give").droppable({
    ...
    drop: function(event, ui) {
        ...
        $.post(
            "https://norskpixel-inventory/GiveItem",
            JSON.stringify({
                inventory: fromInventory,
                item: fromData,
                amount: parseInt(amount),
