...
RegisterServerEvent("norskpixel-hud:Server:UpdateStress")
AddEventHandler('norskpixel-hud:Server:UpdateStress', function(StressGain)
	local src = source
...
RegisterServerEvent('norskpixel-hud:Server:GainStress')
AddEventHandler('norskpixel-hud:Server:GainStress', function(amount)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local newStress
    if Player ~= nil then
...
RegisterServerEvent('norskpixel-hud:Server:RelieveStress')
AddEventHandler('norskpixel-hud:Server:RelieveStress', function(amount)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local newStress
    if Player ~= nil then
