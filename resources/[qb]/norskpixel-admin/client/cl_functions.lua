...
function GetMoneyTypes()
    ...
    if Types ~= nil then
        ...
        DebugPrint('money', 'Could not access Config.Money.MoneyTypes, please check if you have the latest version of QBCore or the right name for the norskpixel-core config.')
    end
    return Citizen.Await(Prom)
end
